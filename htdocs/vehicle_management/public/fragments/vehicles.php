...
.skel-cell{height:14px;border-radius:6px;background:linear-gradient(90deg,#e8e8e8 25%,#f5f5f5 50%,#e8e8e8 75%);background-size:200% 100%;animation:v-shimmer 1.5s infinite}
...
(function(){
    ...
    function showSkeleton(){
        ...
        $('tableBody').innerHTML=Array(rows).fill(row).join('');
    }
