...
// Fields supported:
// - full_name, username, email, phone, emp_id, preferred_language
...
// return updated user
$s = $conn->prepare("SELECT id, emp_id, username, full_name, email, phone, preferred_language, department_id, section_id, division_id FROM users WHERE id = ? LIMIT 1");
$s->bind_param('i', $uid);
$s->execute();
$res = $s->get_result();
